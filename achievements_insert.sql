...
-- First, clear existing achievements (optional - only if you want to start fresh)
...
(9, 'Protein Power', 'You hit your daily protein target!', 'fas fa-drumstick-bite', 'Nutrition', 'Meet your daily protein goal (e.g., 1.6g per kg body weight).', 'protein_target_met_times', 1.00, NULL, 10),
...
(11, 'Macro Master', 'You hit all three macro targets (protein, carbs, fat) in one day!', 'fas fa-chart-pie', 'Nutrition', 'Meet protein, carbs, and fat targets in a single day.', 'all_macros_met', 1.00, NULL, 25),
...
(23, 'Progress Tracker', 'You logged your weight for the first time!', 'fas fa-chart-line', 'Profile', 'Log your weight in the weight tracker.', 'first_weight_log', 1.00, NULL, 10),
...
(25, 'Early Riser Meal', 'Logged breakfast before 8:00 AM.', 'fas fa-sun', 'Habits', 'Log your breakfast entry before 8 AM on any day.', 'early_breakfast', 1.00, NULL, 10),
(26, 'Early Bird', 'You logged breakfast before 7:00 AM!', 'fas fa-sun', 'Habits', 'Log your breakfast entry before 7 AM.', 'early_breakfast', 1.00, NULL, 15),
